...
async function getDataInBus(){
    const res1=await fetch("https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=3369372a41f4414c91545c9d96e76654 ")
...
async function getDataInPol(){
    const res2=await fetch("https://newsapi.org/v2/top-headlines?country=in&category=politics&apiKey=3369372a41f4414c91545c9d96e76654 ")
...
async function getDataInEnt(){
    const res3=await fetch("https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=3369372a41f4414c91545c9d96e76654 ")
...
async function getDataInTech(){
    const res4=await fetch("https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=3369372a41f4414c91545c9d96e76654 ")
